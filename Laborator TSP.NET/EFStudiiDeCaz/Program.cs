...
namespace EFStudiiDeCaz
{
    class Program
    {
        ...
        static void TestSelfReferences()
        {
            ...
            {
                SelfReference sr1 = new SelfReference()
                {
                    Name = "Cinci"
                };

                SelfReference sr2 = new SelfReference()
                {
                    Name = "Sase"
                };

                sr1.References.Add(sr2);
                context.SelfReferences.Add(sr1);
                context.SelfReferences.Add(sr2);
                context.SaveChanges();
